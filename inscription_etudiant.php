...
if(isset($_POST['inscription_etudiant'])) {
    $nom = $_POST['nom'];
    $email = $_POST['email'];
    ...
    $requete = $connexion->prepare("INSERT INTO etudiants (nom, email, niveau_etude ,passwords) VALUES (?, ?, ?, ?)");
    $requete->bind_param("ssss", $nom, $email, $niveau_etude, $hashed_password);
...
<div class="container">
    <div class="form_area">
        <p class="title">Inscription Etudiant</p>
        <form action="inscription_etudiant.php" method="post">
            ...
            <div class="form_group">
                ...
                <input placeholder="Entrez votre email" id="email" class="form_style" type="email" name="email">
            </div>

            <div class="form_group">
                <label class="sub_title" for="niveau_etude">Niveau</label>
                <input placeholder="Niveau D'etude" id="email" class="form_style" type="text" name="niveau_etude">
            </div>
            ...
            <div>
            <button class="btn" name="inscription_etudiant">S'inscrire</button>
